...
class IntlPhoneField extends StatefulWidget {
  ...
  /// if "false": do not show country select dialog
  final bool countryEnabled;

  /// do function when CountryTapped
  final void Function()? onCountryTapWhenDisabled;
  ...
  final double flagNumberPadding;
  ...
  Widget build(BuildContext context) {
    final numberField = TextFormField(
      ...
      decoration: widget.decoration.copyWith(
        prefixIcon: (widget.isVerticalLayout) ? null : _buildFlagsButton(),
    ...
    return (widget.isVerticalLayout)
        ? Column(
            mainAxisSize: MainAxisSize.min,
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              _buildFlagsButton(),
              SizedBox(height: widget.flagNumberPadding),
              numberField,
            ],
          )
        : numberField;
    ...
    return Container(
      ...
      child: DecoratedBox(
        ...
        child: InkWell(
          ...
          onTap: widget.countryEnabled
              ? _changeCountry
              : widget.onCountryTapWhenDisabled,
          child: Padding(
